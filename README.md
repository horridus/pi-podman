...
MARIADB_DATABASE=pi
MARIADB_USER=pi
MARIADB_PASSWORD=REPLACE_WITH_RANDOM_USER_PASSWORD
...
| `MARIADB_PASSWORD` | Password utente applicativo MariaDB | `REPLACE_WITH_RANDOM_USER_PASSWORD` | No |
| `MARIADB_ROOT_PASSWORD` | Password utente `root` MariaDB | `REPLACE_WITH_RANDOM_ROOT_PASSWORD` | No |
